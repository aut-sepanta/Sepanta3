...
#include <athomerobot_msgs/sepantaAction.h> //movex movey turngl turngllocal actions
#include <athomerobot_msgs/slamactionAction.h> //slam action

#include <std_msgs/Int32.h>
#include <std_msgs/Bool.h>

//#include <std_msgs/Bool.h>
#include "athomerobot_msgs/stop.h"

typedef actionlib::SimpleActionClient<athomerobot_msgs::slamactionAction> SLAMClient;
typedef actionlib::SimpleActionClient<athomerobot_msgs::sepantaAction> SepantaClient;
...
void goWithOdometry(string mode,int value)
{
    ...
    athomerobot_msgs::sepantaGoal interfacegoal;
...
bool checkcommand(athomerobot_msgs::command::Request  &req,athomerobot_msgs::command::Response &res)
{
...
void checkkeypad(const std_msgs::Int32::ConstPtr &topicMsg)
{
    ...
    {
    	//manual mode start
    	// athomerobot_msgs::stop srv_stop;
...
int main(int argc, char** argv)
{
  ...
  serviceclient_facestop = n_client1.serviceClient<athomerobot_msgs::stop>("speechOrFace_Stop");

  ros::NodeHandle n_client2;
  serviceclient_manualauto = n_client2.serviceClient<athomerobot_msgs::stop>("manualOrAuto");
