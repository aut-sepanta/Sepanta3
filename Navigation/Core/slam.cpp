...
typedef actionlib::SimpleActionServer<athomerobot_msgs::slamactionAction> slam_Server;
...
bool checkmaptools(athomerobot_msgs::maptools::Request  &req,athomerobot_msgs::maptools::Response &res)
{
...
protected:
  ...
  actionlib::SimpleActionServer<athomerobot_msgs::slamactionAction> as_;
  std::string action_name_;

  athomerobot_msgs::slamactionFeedback feedback_;
  athomerobot_msgs::slamactionResult result_;
...
public:
  ...
  void executeCB(const athomerobot_msgs::slamactionGoalConstPtr &interfacegoal)
  {
...
int main(int argc, char** argv)
{
  ...
  client = n_client.serviceClient<athomerobot_msgs::maptools>("AUTROBOTINSRV_mapsaver");
