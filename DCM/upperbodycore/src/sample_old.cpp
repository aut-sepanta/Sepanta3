...
int grip_process(double xend,double yend,double zend,double al,double be,double ga)
{
...
void logic()
{
    //CHANGE TO SERVICE MODE WE DONT NEED THIS HERE
...
void grip_thread()
{
    ...
    while (ros::ok() && appExit == false )
    {
        if ( start_grip )
        {
            int result = grip_process(end_position.x,end_position.y,end_position.z,end_position.a,end_position.b,end_position.g);
