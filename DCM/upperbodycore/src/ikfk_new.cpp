...
int show()
{
    ...
    boost::this_thread::sleep(boost::posix_time::milliseconds(4000));//delay for talking
...
int Global_end()
{
    ...
    gClinet->setMotor_rightGripper(gClinet->getMotor_rightGripper().init,300);
    ...
    gClinet->setMotor_leftGripper(gClinet->getMotor_leftGripper().init,300);

    gClinet->setMotor_waist(gClinet->getMotor_waist().init,300);
}
...
int start_left(int d)
{
    ...
    std::cout<<"motor sent commands are="<<std::endl<<Qs_Ysend<<std::endl<<Qs_Xsend<<std::endl<<Qs_Zsend<<std::endl<<Qe_Ysend<<std::endl<<Qw_Zsend<<std::endl<<Qw_Ysend<<std::endl<<Qw_Xsend<<std::endl<<std::endl ;
    boost::this_thread::sleep(boost::posix_time::milliseconds(Time*3000));
