...
//        std::cout<<"nomotors"<<std::endl;
    ...
    if (Flag==0)
    {
        std::cout << "There is not any answer. error : "<<Error<<std::endl;
    }

  std::cout<<"desired angles are="<<Qs_Xrad<<std::endl<<Qs_Yrad<<std::endl<< Qs_Zrad<<std::endl<< Qe_Yrad<<std::endl<< Qw_Zrad<<std::endl<< Qw_Yrad<<std::endl<<Qw_Xrad<<std::endl <<std::endl ;
  ...
  std::cout<<"motor sent commands are="<<std::endl<<Qs_Xsend<<std::endl<<Qs_Ysend<<std::endl<<Qs_Zsend<<std::endl<<Qe_Ysend<<std::endl<<Qw_Zsend<<std::endl<<Qw_Ysend<<std::endl<<Qw_Xsend<<std::endl<<std::endl ;
  ...
  std::cout<<"motor read positions are="<<std::endl<<aa<<std::endl<<bb<<std::endl<<cc<<std::endl<<dd<<std::endl<<ee<<std::endl<<ff<<std::endl<<gg<<std::endl <<std::endl;
